(function(c) {
        ...
        X = function() {
            if (!W) {
                ...
                var a = function() {
                        ...
                        n(j, 1);
                        if (d.crawlable) {
                            var h = k.pathname.replace(/\/$/, ""); - 1 != c("body").html().indexOf("_escaped_fragment_") && c('a[href]:not([href^=http]), a[href*="' + document.domain + '"]').each(function() {
    ...
    c.address = {
        ...
        baseURL: function() {
            var a = k.href; - 1 != a.indexOf("#") && (a = a.substr(0, a.indexOf("#")));
        ...
        value: function(a) {
            if (a !== j) {
                ...
                e = a;
                if (d.autoUpdate || L)
                    if (D(l), B()) v[d.history ? "pushState" : "replaceState"]({}, "", d.state.replace(/\/$/, "") + ("" === e ? "/" : e));
                    else t = l, x ? d.history ? k.hash = "#" + p(e, l) : k.replace("#" + p(e, l)) : e != q() && (d.history ? k.hash = "#" + p(e, l) : k.replace("#" + p(e, l))), s && !C && d.history && n(J, 50), x ? n(function() {
                        t = h
                    }, 1) : t = h;
                return this
            }
        ...
        parameterNames: function() {
            ...
            if (a && -1 != a.indexOf("="))
                for (var a = a.split("&"), d = 0; d < a.length; d++) {
                    var e = a[d].split("=")[0]; - 1 == c.inArray(e, b) && b.push(e)
                }
            return b
        },
        hash: function(a) {
...
(function() {
    ...
    var R = window.getComputedStyle ? document.defaultView.getComputedStyle : null,
        ...
        K = 500,
        f;
    f = y.search("msie"); - 1 === f ? f = [33.3, 0] : (f = parseInt(y.substr(f + 4, f + 5), 10), f = [9 <= f ? 16.6 : 33.3, f]);
    var h = [],
        ...
        u, L, t = 0,
        ka, Q, Z, $, W, F, G, V, aa, A, ba, S, T, ca, la, ra = /,/g,
        sa = /[A-Z]/g,
        ta = / cj-tween/g,
        ua = /^\s+|\s+$/g,
        va = /{props}/,
    ...
    if (E)
        if (8 === f) ba = /(#|rgb|red|blue|green|black|white|yellow|pink|gray|grey|orange|purple)/, T = /(auto|inherit|rgb|%|#|red|blue|green|black|white|yellow|pink|gray|grey|orange|purple)/, ca = {
            red: "#F00",
            blue: "#00F",
            green: "#0F0",
            black: "#000",
    ...
    else ba = /(#|rgb)/, T = /(auto|inherit|rgb|%|#)/;
    ...
    CJ.prototype.bgPosition = function(a, b, c, d, n) {
        ...
        if (j) {
            ...
            "left" === w && (w = 0);
            "top" === x && (x = 0)
        } else u = "" !== p ? p.split(" ") : R(a, null).backgroundPosition.split(" "), w = u[0], x = u[1]; - 1 !== w.search("%") && "0%" !== w && (k = !1); - 1 !== x.search("%") && "0%" !== x && (k = !1);
        w = parseInt(w, 10);
        x = parseInt(x, 10);
        ...
        if (d) {
            ...
            if (a) {
                ...
                for (var n = a.length, m, g; n--;)
                    if (m = a[n].stored, g = m[0], E) switch (g) {
                        case "Opacity":
            ...
            if (!0 === g) d.moves = "";
                ...
                for (p in b)
                    if (b.hasOwnProperty(p)) {
                        r = p;
                        if (j = r.match(sa))
                            for (e = j.length; e--;) k = j[e], r = r.replace(RegExp(k, "g"), "-" + k.toLowerCase());
                        k = e = b[p];
...
(function(c) {
        ...
        if (e) {
            ...
            if (-1 < g) {
                ...
                for (m = e.length; m--;)
                    if (l = e[m], l[0] === d[0]) {
                        if (b)
                            if (e.splice(m, 1), l.off("click.jackbox"), d = e.length)
                                for (g = 0; g < d; g++) e[g].data("id", g);
                            else K.splice(g, 1), L.splice(g, 1), Ra--;
                        return
                    }
                m = e.length;
                e[m] = d
    ...
    function Wc(a) {
        ...
        clearTimeout(Sa);
        hc(a.value); - 1 !== H ? ic ? (ic = !1, zb()) : Sa = setTimeout(zb, 750) : aa && Ab()
    }

    function zb(a) {
        "object" === typeof a && (clearTimeout(Sa), hc(a.value)); - 1 !== H ? jc() : aa && Ab()
    }
    ...
    function bb(a, b, d) {
        ...
        if (!d) {
            if (M)
                for (d = x.length; d--;) x[d].off("click.jackbox");
            ja.off(".jackbox");
            ta.off(".jackbox");
    ...
    function jc() {
        ...
        if (e = eb[f]) {
            if (s)
                for (var a = [v[0], ia[0], w[0], ka[0]], b = 4; b--;) a[b].addEventListener("touchstart", D, !1), a[b].addEventListener("touchmove", D, !1), a[b].addEventListener("touchend", D, !1);
    ...
    var k = {
        ...
        Tc = function() {
            ...
            return function() {
                ...
                if (X) {
                    if (M)
                        for (d = x.length; d--;) x[d].on("click.jackbox", Cc);
        ...
        vd = function() {
            ...
            return function() {
                ...
                if (Za && !tb) {
                    var m, b = r.URL.split("#")[0],
                        d = b.length - 1; - 1 !== b.search("/") && ("/" !== b.charAt(d) ? (W ? m = b + "#/" + ma + "/" + (f + 1) : m = b, b = b.substring(0, b.lastIndexOf("/"))) : (b = b.substring(0, d), W ? m = b + "/#/" + ma + "/" + (f + 1) : m = b));
                    Va ? d = e.attr("href") || e.attr("data-href") : (d = e.children("img"), d = d.length ? d.attr("src") : Pc); - 1 === d.search("http") && (d = "/" !== d.charAt(0) ? b + "/" + d : b + d);
        ...
        Mb = function() {
            ...
            return function(d, c) {
                ...
                da.off(".jackbox");
                if ($b)
                    if (s && u.cjSwipe("unbindSwipe"), y < R - ra ? (da.on("click.jackbox", Ac).show(), s && u.cjSwipe("touchSwipeLeft", Ac, !0)) : da.hide(), 0 < y ? (ca.on("click.jackbox", Bc).show(), s && u.cjSwipe("touchSwipeRight", Bc, !0)) : ca.hide(), c) a.left = y * -ga, Jacked.tween(V[0], a, b);
                    else {
                        if (d || !Pb) {
                            var e = u.offset().left;
                            ca.css("left", e);
